...
# Implements Part 1 of the Computer Networks Lab assignment.
...
def get_network_prefix(ip_cidr: str) -> str:
    ...
    For example: "200.23.16.0/23" -> "11001000000101110001000"
    """
    try:
...
if __name__ == "__main__":
    ...
    # Test Case 1: ip_to_binary (from example)
    ip1 = "192.168.1.1"
    ...
    # Test Case 2: ip_to_binary (with zeros that need padding)
    ip2 = "10.0.2.1"
    ...
    # Test Case 3: get_network_prefix (from example)
    ...
    # Test Case 4: Another get_network_prefix
    cidr2 = "223.1.1.0/24" # From Part 2 test cases
